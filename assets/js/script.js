...
var questions = [
  {
    question:
      "Which Legend's passive ability is the ability to fly using jets?",
  ...
  {
    question:
      "Which Legend was obviously inspired by 'Old Town Road' rapper 'Lil Nas X'?",
  ...
  {
    question:
      "Which weapon is NOT in the current Season (Season 12) Care Package?",
  ...
  },
  {
    ...
    question:
      "*Trick Question* Which Legend is famous for deploying clones to 'Bamboozle?'",
    answers: ["Mirage", "Mirage", "Mirage", "Mirage"],
    answer: 3,
  },
  {
    question:
      "Which Legend is the goto choice for sweats and will hot drop, get knocked, and immediately disconnect?",
...
function populateHighScores() {
  ...
  if (storedHighScores !== null) {
    storedHighScores = storedHighScores.sort((a, b) => b.score - a.score);
